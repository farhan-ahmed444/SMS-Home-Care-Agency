...
export default function Contact() {
  ...
  return (
    <section id="contact" className="section bg-surface-dark relative overflow-hidden">
      <div data-parallax data-speed="0.15" className="absolute top-0 right-0 w-80 h-80 bg-primary/10 rounded-full blur-3xl" />
      <div data-parallax data-speed="0.3" className="absolute bottom-0 left-0 w-60 h-60 bg-primary/5 rounded-full blur-3xl" />

      <div className="container-custom">
        <div data-reveal className="text-center mb-14">
          <span className="badge-dark mb-4">Contact Us</span>
          ...
          >
            ...
            <div className="card-lg">
              ...
              <div className="space-y-2.5 text-sm">
                ...
                <div className="border-t border-primary-lighter/10" />
                <div className="flex justify-between items-center">
            ...
            <form onSubmit={handleSubmit} className="card-lg space-y-4">
              <div>
                ...
                <input id="name" type="text" value={form.name} onChange={(e) => setForm({ ...form, name: e.target.value })}
                  className={`w-full px-4 py-3 rounded-xl bg-neutral/70 border ${errors.name ? "border-red-400" : "border-neutral-dark/40"} focus:border-primary focus:ring-2 focus:ring-primary/10 outline-none transition-all text-secondary text-sm placeholder:text-secondary-lighter/40`}
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input id="email" type="email" value={form.email} onChange={(e) => setForm({ ...form, email: e.target.value })}
                    className={`w-full px-4 py-3 rounded-xl bg-neutral/70 border ${errors.email ? "border-red-400" : "border-neutral-dark/40"} focus:border-primary focus:ring-2 focus:ring-primary/10 outline-none transition-all text-secondary text-sm placeholder:text-secondary-lighter/40`}
                ...
                <div>
                  ...
                  <input id="phone" type="tel" value={form.phone} onChange={(e) => setForm({ ...form, phone: e.target.value })}
                    className={`w-full px-4 py-3 rounded-xl bg-neutral/70 border ${errors.phone ? "border-red-400" : "border-neutral-dark/40"} focus:border-primary focus:ring-2 focus:ring-primary/10 outline-none transition-all text-secondary text-sm placeholder:text-secondary-lighter/40`}
              ...
              <div>
                ...
                <select id="careNeeds" value={form.careNeeds} onChange={(e) => setForm({ ...form, careNeeds: e.target.value })}
                  className={`w-full px-4 py-3 rounded-xl bg-neutral/70 border ${errors.careNeeds ? "border-red-400" : "border-neutral-dark/40"} focus:border-primary focus:ring-2 focus:ring-primary/10 outline-none transition-all text-secondary text-sm`}
                >
              ...
              <div>
                ...
                <textarea id="message" rows={4} value={form.message} onChange={(e) => setForm({ ...form, message: e.target.value })}
                  className={`w-full px-4 py-3 rounded-xl bg-neutral/70 border ${errors.message ? "border-red-400" : "border-neutral-dark/40"} focus:border-primary focus:ring-2 focus:ring-primary/10 outline-none transition-all text-secondary text-sm resize-none placeholder:text-secondary-lighter/40`}
